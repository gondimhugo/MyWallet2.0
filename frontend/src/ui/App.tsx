...
export default function App() {
  ...
  return <Routes><Route element={<Layout onLogout={() => { localStorage.clear(); setToken(null) }} />}><Route path='/' element={<Dashboard />} /><Route path='/transactions' element={<Transactions />} /><Route path='/invoices' element={<Invoices />} /><Route path='/planning' element={<Planning />} /><Route path='/salary' element={<Salary />} /><Route path='/settings' element={<Settings />} /></Route><Route path='*' element={<Navigate to='/' />} /></Routes>
}
